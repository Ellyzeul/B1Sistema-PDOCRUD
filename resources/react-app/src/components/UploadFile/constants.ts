...
export const fields = {
  ...
  "order-estante-insert": [
    {label: "Estante", field_name: "book_type", updatable: false, required: false}, 
    {label: "ISBN", field_name: "isbn", updatable: false, required: false}, 
    {label: "Comprador", field_name: "buyer_name", updatable: false, required: false}, 
    {label: "CPF/CNPJ", field_name: "cpf_cnpj", updatable: false, required: false}, 
    {label: "Destinatário", field_name: "recipient_name", updatable: false, required: false}, 
    {label: "Endereço", field_name: "full_address", updatable: false, required: false}, 
    {label: "Logradouro", field_name: "address_1", updatable: false, required: false}, 
    {label: "Número", field_name: "address_2", updatable: false, required: false}, 
    {label: "Complemento", field_name: "address_3", updatable: false, required: false}, 
    {label: "Bairro", field_name: "county", updatable: false, required: false}, 
    {label: "Estado", field_name: "state", updatable: false, required: false}, 
    {label: "UF", field_name: "uf", updatable: false, required: false}, 
    {label: "Cidade", field_name: "city", updatable: false, required: false}, 
    {label: "CEP", field_name: "postal_code", updatable: false, required: false}, 
    {label: "Forma de envio", field_name: "delivery_method", updatable: false, required: false}, 
    {label: "Código de rastreio", field_name: "tracking_code", updatable: false, required: false}, 
    {label: "Link de rastreio", field_name: "tracking_link", updatable: false, required: false}, 
    {label: "Valor do frete (R$)", field_name: "freight", updatable: false, required: false}, 
    {label: "Juros (R$)", field_name: "item_tax", updatable: false, required: false}, 
    {label: "Preço do Livro (R$)", field_name: "price", updatable: false, required: false}, 
    {label: "Valor Total (R$)", field_name: "total_price", updatable: false, required: false}, 
  ],
  "fsist-ingestion": [
