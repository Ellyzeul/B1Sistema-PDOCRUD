  ...
  return (
    <div className="expenses-page">
      ...
      <div className="expenses-page-container">
        ...
        <div className="fiscal-page-table-container">
          <table>
            <thead>
              <tr>
                <th>ID</th>
...
function ExpenseRow({expense, categories, banks, payment_methods}: ExpenseRowProp) {
  ...
  return (
    <>
      <tr onClick={() => setIsModalOpen(false)}>
        <td>{expense.id}</td>
        ...
        <td><input defaultValue={expense.payment_date ?? ''} onBlur={({target}) => {
          api.post('/api/expense/update-fiscal', {
            ...
            .then(() => toast.success('Registro atualizado'))
            .catch(() => toast.error('Erro atualizando o registro'))
        }}/></td>
      </tr>
      <Modal
        isOpen={isModalOpen}
          ...
          <div className="expense-page-modal-is-close-form-supplier">
            ...
            <div className="supplier-purchase-split-container">
              <div>
                ...
                <input name="value" defaultValue={String(savedExpense?.value).replace('.', ',') ?? 0}/>
                <br />
