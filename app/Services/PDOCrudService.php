...
class PDOCrudService
{
	...
	private array $columnsPerPhase = [
		...
		"tracking_code" => ["general", "2.4", "2.5", "2.6", "2.7", "2.8", "2.9", "4.1", "4.2", "5.1", "5.2", "5.3", "5.4", "5.5", "6.1", "6.2", "6.21", "7.0", "8.1", "8.12", "8.13", "8.2", "8.3", "8.4", "8.5", "8.6", "não-verificado", "não-enviado"],
