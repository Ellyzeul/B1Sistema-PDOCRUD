...
class PDOCrudService
{
	...
	private array $columnsPerPhase = [
		...
		"ship_date" => ["general", "0.0", "1.1", "1.2" ,"1.3", "1.4", "1.5", "2.0", "2.1", "2.11", "2.2", "2.3", "2.4", "2.41", "2.5", "2.6", "2.7", "2.8", "2.9", "3.1", "3.2", "4.1", "4.2", "4.3", "5.1", "não-verificado", "não-enviado", "aceitar-fnac"],
