...
class B1Servicos
{
  ...
  public function orderTrackingCodePost(string $orderNumber, string $sellercentral, string $company, string $trackingNumber, string $shipDate, ?string $customService)
  {
